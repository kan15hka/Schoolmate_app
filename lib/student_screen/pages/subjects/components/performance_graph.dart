      ...
      child: LineChart(LineChartData(
          ...
          gridData: FlGridData(
            ...
            getDrawingHorizontalLine: (value) {
              return FlLine(
                  color: const Color.fromARGB(255, 235, 231, 231), strokeWidth: 1.5);
            },
          ...
          borderData: FlBorderData(
              show: true, border: Border.all(color: k3GreyColor, width: 1.5)),
          lineBarsData: [
            LineChartBarData(
                isCurved: true,
                color: const Color.fromARGB(255, 130, 41, 211),
                barWidth: 3.0,
                ...
                belowBarData: BarAreaData(
                    show: true, color: const Color.fromARGB(20, 130, 41, 211)))
          ])),
    );
  }
}
...
Widget leftTitlesWidget(double value, TitleMeta meta) {
  var style = const TextStyle(fontSize: 15.0, color: Colors.black);
  Widget text;
  switch (value.toInt()) {
    case 5:
      text = Text(
